...
possible, always discard the first third (1/e'th, where e is [Euler's Number](https://en.wikipedia.org/wiki/E_(mathematical_constant)), to be precise) of the options and then pick the next
