function kingsJewelsExample() {
    ...
    function jewelsRegressionLineChart(divName, filename) {
        ...
        */
        ...
        jewelsMultiHistogram('#kj-plotting-area', '/jsons/kings_jewels/10_uniform.json');
        jewelsMultiHistogram('#kj-plotting-area-normal', '/jsons/kings_jewels/10_normal.json');
        jewelsMultiHistogram('#kj-plotting-area-exponential', '/jsons/kings_jewels/10_exponential.json');

        jewelsRegressionLineChart('#kj-regression-area', '/jsons/kings_jewels/all_stats_uniform.csv');
        jewelsRegressionLineChart('#kj-regression-area-normal', '/jsons/kings_jewels/all_stats_normal.csv');
        jewelsRegressionLineChart('#kj-regression-area-exponential', '/jsons/kings_jewels/all_stats_exponential.csv');
}
