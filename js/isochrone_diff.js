function drawIsochroneDiff(initialLat, initialLon, travelTimeGridJson) {
    //var map = L.map('isochroneDiff').setView([48.2858, 6.7868], 4);
    var map = new L.Map("isochroneDiff", {
    ...
    var svg = d3.select("#isochroneDiff").select("svg");
    ...
    function drawLegend() {
        ...
        var svgLegend = d3.select("#isochroneDiffLegend").append("svg");
